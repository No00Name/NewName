...
<div class="container" style="max-width:500px;">
    ...
    <div class="mb-3 mt-5">
        ...
        <input type="password" name="password" id="password" class="form-control @error(pPassword') is-invalid @enderror" placeholder="password">
    </div>

    <button type="sudmit" class="btn btn-primary">Вход</button>
    </form>
</div>
